...
<body onload="startTime()">
	...
	<div class="menu-bar"
		...
		<div class="title-content">Kiểm tra thông tin email khách hàng</div>
		<form action="${pageContext.request.contextPath}/check_email"
		...
		<div class="themThongTinTraSoatISS" style="height: 50px">
			<div id="thediv_scroll"
				...
				<table rules="groups" frame="hsides" id="testTable"
					...
					<tbody>
						<c:forEach items="${list_email}" var="p">
